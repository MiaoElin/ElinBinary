...
public static class Test {
    ...
    public static void Entry() {
        ...
        Debug.Log(Convert.ToString((sbyte)a, 2));
        Debug.Log(Convert.ToString((int)(sbyte)a, 2));

        Debug.Log(Convert.ToString((uint)a, 2));
        Debug.Log(Convert.ToString((int)(uint)a, 2));
